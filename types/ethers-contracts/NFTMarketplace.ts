...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener, TypedContractMethod } from "./common.js"
  ...
  export interface NFTMarketplaceInterface extends Interface {
    getFunction(nameOrSignature: "approve" | "balanceOf" | "buyItem" | "getApproved" | "isApprovedForAll" | "listItem" | "listings" | "mintNFT" | "name" | "owner" | "ownerOf" | "renounceOwnership" | "safeTransferFrom(address,address,uint256)" | "safeTransferFrom(address,address,uint256,bytes)" | "setApprovalForAll" | "supportsInterface" | "symbol" | "tokenURI" | "transferFrom" | "transferOwnership"): FunctionFragment;

    getEvent(nameOrSignatureOrTopic: "Approval" | "ApprovalForAll" | "BatchMetadataUpdate" | "ItemListed" | "ItemSold" | "MetadataUpdate" | "NFTMinted" | "OwnershipTransferred" | "Transfer"): EventFragment;
...
decodeFunctionResult(functionFragment: 'transferOwnership', data: BytesLike): Result;
    ...
    export namespace NFTMintedEvent {
      export type InputTuple = [tokenId: BigNumberish, owner: AddressLike, tokenURI: string];
      export type OutputTuple = [tokenId: bigint, owner: string, tokenURI: string];
      export interface OutputObject {tokenId: bigint, owner: string, tokenURI: string };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
